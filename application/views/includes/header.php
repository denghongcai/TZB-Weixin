    ...
    <header class="bg-dark">
        <div class="navigation-bar fixed-top shadow">
            <div class="navigation-bar-content container">
                <a href="<?=base_url('home')?>" class="element"><span class="icon-grid-view"></span> 创青春微信平台管理后台 <sup>0.1</sup></a>
            </div>
        </div>
    </header>
    <div class="container">
                    ...
                    <nav class="sidebar (light)">
                        <ul>
                            ...
                            <li>
                                ...
                                <ul class="dropdown-menu" data-role="dropdown"  <?=  isset($act) && $act == 'content' ? 'style="display: block"' : '';?>>
                            ...
                            <li>
                                ...
                                <ul class="dropdown-menu" data-role="dropdown" <?=  isset($act) && $act == 'knowledge' ? 'style="display: block"' : '';?>>
                            ...
                            <li>
                                ...
                                <ul class="dropdown-menu" data-role="dropdown" <?=  isset($act) && $act == 'comment' ? 'style="display: block"' : '';?>>
                            ...
                            <li>
                                ...
                                <ul class="dropdown-menu" data-role="dropdown" <?=  isset($act) && $act == 'user' ? 'style="display: block"' : '';?>>
